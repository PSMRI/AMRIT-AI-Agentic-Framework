...
```text
/amrit-create-development-pr DEMO-7310
```
...
Run `amrit-implement-jira-ticket` again or resolve the implementation issues first.
...
```text
/amrit-create-development-pr DEMO-7311
```
