...
[`amrit-draft-test-cases/examples/sample-test-specification.md`](../../amrit-draft-test-cases/examples/sample-test-specification.md), executed at Stage 07 against a deployed QA build.
