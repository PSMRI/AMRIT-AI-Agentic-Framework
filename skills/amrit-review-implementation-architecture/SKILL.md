...
metadata:
  ...
  supported_inputs:
    - Architecturally significant scope assigned by amrit-implement-jira-ticket
...
- It does not produce a new technical design; that is `amrit-create-technical-design`.
