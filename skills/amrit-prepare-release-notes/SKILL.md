---
name: amrit-prepare-release-notes
...
release lifecycle. It does not replace `amrit-implement-jira-ticket`,
`amrit-create-development-pr`, `amrit-execute-qa-validation`, `amrit-test-jira-ticket`, or
`amrit-perform-root-cause-analysis`. The skill is independently executable and requires
