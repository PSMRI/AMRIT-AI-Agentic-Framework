...
All UI repositories are Angular applications and route to `amrit-implement-frontend-change`.
...
All API repositories are Spring Boot services and route to `amrit-implement-backend-change`.
...
Kotlin Android applications consuming AMRIT REST APIs. They route to `amrit-implement-android-change`.
...
|---|---|---|
| `AMRIT-DB` | Database schema management through Flyway migrations | `amrit-implement-database-change` |
