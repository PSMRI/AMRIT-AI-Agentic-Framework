...
`amrit-create-technical-design` supports Stage 03 — Engineering Analysis. It helps Technical Architects and Senior Developers research an approved change and produce one evidence-based technical design package before implementation begins.
...
Invoke `/amrit-create-technical-design` from the repository root using a supported
...
**Artifacts**, and download `amrit-create-technical-design.zip` directly. Upload or
